package com.jumbo.pivo.gui.pokuty;
...
public class PokutyFragment extends Fragment {

    private TabLayout tabLayout;
    private ViewPager firstViewPager;

    public PokutyFragment() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new PridatPokutuFrag(), "Přidat\npokutu");
        adapter.addFragment(new PridatZapasFrag(), "Statistiky");
        adapter.addFragment(new StatistikyFrag(), "Nastavení\npokut");
